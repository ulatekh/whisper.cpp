...
%endif
Summary: Compatibility GCC Compiler Collection
Name: compat-gcc-12-3
Version: %{gcc_version}
...
%description
This package contains a GCC 12.3 compatibility compiler.

%package -n compat-libgcc-12-3
...
%description -n compat-libgcc-12-3
This package contains GCC shared support library which is needed
e.g. for exception handling support.

%package c++
Summary: C++ support for GCC
Requires: compat-gcc-12-3 = %{version}-%{release}
%ifarch x86_64 s390x ppc64
Requires: libstdc++.so.6(GLIBCXX_3.4.22)(64bit)
%else
Requires: libstdc++.so.6(GLIBCXX_3.4.22)
%endif
Requires: compat-libstdc++-12-3-devel = %{version}-%{release}
Provides: gcc-g++ = %{version}-%{release}
Provides: g++ = %{version}-%{release}
Autoreq: true

%description c++
This package includes a GCC 12.3 compatibility C++ compiler.

%package -n compat-libstdc++-12-3
Summary: GNU Standard C++ Library
Autoreq: true
Requires: glibc >= 2.10.90-7

%description -n compat-libstdc++-12-3
The libstdc++ package contains a rewritten standard compliant GCC Standard
C++ Library.

%package -n compat-libstdc++-12-3-devel
Summary: Header files and libraries for C++ development
Requires: compat-libstdc++-12-3%{?_isa} = %{version}-%{release}
Autoreq: true

%description -n compat-libstdc++-12-3-devel
This is the GNU implementation of the standard C++ libraries.  This
package includes the header files and libraries needed for C++
development. This includes rewritten implementation of STL.

%package -n compat-libstdc++-12-3-static
Summary: Static libraries for the GNU standard C++ library
Requires: libstdc++-devel = %{version}-%{release}
Autoreq: true

%description -n compat-libstdc++-12-3-static
Static libraries for the GNU standard C++ library.

%package -n compat-libstdc++-12-3-docs
Summary: Documentation for the GNU standard C++ library
Autoreq: true

%description -n compat-libstdc++-12-3-docs
...
Requires: compat-gcc-12-3 = %{version}-%{release}
Requires: compat-libgfortran-12-3 = %{version}-%{release}
...
%package -n compat-libgfortran-12-3
Summary: Fortran runtime for compatibility compiler
Autoreq: true
%if %{build_libquadmath}
Requires: libquadmath = %{version}-%{release}
%endif

%description -n compat-libgfortran-12-3
This package contains Fortran shared library which is needed to run
Fortran dynamically linked programs.

%package -n compat-libgfortran-12-3-static
Summary: Static Fortran libraries for compatibility compiler
Requires: compat-libgfortran-12-3 = %{version}-%{release}
Requires: compat-gcc-12-3 = %{version}-%{release}
%if %{build_libquadmath}
...
%description -n compat-libgfortran-12-3-static
This package contains static Fortran libraries.

%package compat-gdc-12-3
Summary: D support
Requires: compat-gcc-12-3 = %{version}-%{release}
Requires: compat-libgphobos-12-3 = %{version}-%{release}
Provides: gcc-d = %{version}-%{release}
Provides: gdc = %{version}-%{release}
Autoreq: true

%description compat-gdc-12-3
The gcc-gdc package provides support for compiling D
programs with the GNU Compiler Collection.

%package -n compat-libgphobos-12-3
Summary: D runtime
Autoreq: true

%description -n compat-libgphobos-12-3
This package contains D shared library which is needed to run
D dynamically linked programs.

%package -n compat-libgphobos-12-3-static
Summary: Static D libraries
Requires: compat-libgphobos-12-3 = %{version}-%{release}
Requires: compat-gcc-12-3-gdc = %{version}-%{release}

%description -n compat-libgphobos-12-3-static
This package contains static D libraries.

%package -n compat-libgomp-12-3
Summary: GCC OpenMP v4.5 shared support library

%description -n compat-libgomp-12-3
This package contains GCC shared support library which is needed
for OpenMP v4.5 support.

%package -n compat-libgomp-12-3-offload-nvptx
Summary: GCC OpenMP v4.5 plugin for offloading to NVPTX
Requires: compat-libgomp-12-3 = %{version}-%{release}

%description -n compat-libgomp-12-3-offload-nvptx
...
%package -n compat-cpp-12-3
Summary: The C Preprocessor
Requires: filesystem >= 3
Provides: /lib/cpp
Autoreq: true

%description -n compat-cpp-12-3
...
ln -sf ../bin/cpp-12-3 %{buildroot}/%{_prefix}/lib/cpp-12-3
...
# Rename executables
for i in $RPM_BUILD_ROOT%{_prefix}/bin/{*gcc,*++,gcov*,gfortran,gcc-ar,gcc-nm,gcc-ranlib,lto-dump,cpp}; do
  mv -f $i ${i}-12-3
done

# Rename info files
mv %{buildroot}/%{_infodir}/libgccjit.info.gz %{buildroot}/%{_infodir}/libgccjit-12-3.info.gz
mv %{buildroot}/%{_infodir}/gcc.info.gz %{buildroot}/%{_infodir}/gcc-12-3.info.gz
mv %{buildroot}/%{_infodir}/gccinstall.info.gz %{buildroot}/%{_infodir}/gccinstall-12-3.info.gz
mv %{buildroot}/%{_infodir}/gccint.info.gz %{buildroot}/%{_infodir}/gccint-12-3.info.gz
mv %{buildroot}/%{_infodir}/gfortran.info.gz %{buildroot}/%{_infodir}/gfortran-12-3.info.gz
mv %{buildroot}/%{_infodir}/libgomp.info.gz %{buildroot}/%{_infodir}/libgomp-12-3.info.gz
mv %{buildroot}/%{_infodir}/libquadmath.info.gz %{buildroot}/%{_infodir}/libquadmath-12-3.info.gz
mv %{buildroot}/%{_infodir}/libitm.info.gz %{buildroot}/%{_infodir}/libitm-12-3.info.gz
...
# libstdc++.so.6 is included by base libstdc++ package.
rm -f $RPM_BUILD_ROOT%{_prefix}/%{_lib}/libstdc++.so $RPM_BUILD_ROOT%{_prefix}/%{_lib}/libstdc++.so.6

# Add symlink to lto plugin in the binutils plugin directory.
%{__mkdir_p} %{buildroot}%{_libdir}/bfd-plugins/
ln -s ../../libexec/gcc/%{gcc_target_platform}/%{gcc_major}/liblto_plugin.so \
  %{buildroot}%{_libdir}/bfd-plugins/liblto_plugin-12-3.so
...
# libgcc is installed
%post -n compat-libgcc-12-3 -p <lua>
...
%postun -n compat-libgcc-12-3 -p <lua>
if posix.access ("/sbin/ldconfig", "x") then
  local pid = posix.fork ()
  if pid == 0 then
    posix.exec ("/sbin/ldconfig")
...
%ldconfig_scriptlets -n compat-libstdc++-12-3

%if %{build_objc}
%ldconfig_scriptlets -n compat-libobjc-12-3
%endif

%ldconfig_scriptlets -n compat-libgfortran-12-3

%ldconfig_scriptlets -n compat-libgphobos-12-3

%if %{build_ada}
%ldconfig_scriptlets -n compat-libgnat-12-3
%endif

%ldconfig_scriptlets -n compat-libgomp-12-3

%ldconfig_scriptlets compat-gdb-plugin-12-3

%ldconfig_scriptlets -n compat-libgccjit-12-3

%if %{build_libquadmath}
%ldconfig_scriptlets -n compat-libquadmath-12-3
%endif

%if %{build_libitm}
%ldconfig_scriptlets -n compat-libitm-12-3
%endif

%if %{build_libatomic}
%ldconfig_scriptlets -n compat-libatomic-12-3
%endif

%if %{build_libasan}
%ldconfig_scriptlets -n compat-libasan-12-3
%endif

%if %{build_libubsan}
%ldconfig_scriptlets -n compat-libubsan-12-3
%endif

%if %{build_libtsan}
%ldconfig_scriptlets -n compat-libtsan-12-3
%endif

%if %{build_liblsan}
%ldconfig_scriptlets -n compat-liblsan-12-3
%endif

%if %{build_go}
%ldconfig_scriptlets -n compat-libgo-12-3
%endif

%files -n %{name}
%{_prefix}/bin/gcc-12-3
%{_prefix}/bin/gcov-12-3
%{_prefix}/bin/gcov-tool-12-3
%{_prefix}/bin/gcov-dump-12-3
%{_prefix}/bin/gcc-ar-12-3
%{_prefix}/bin/gcc-nm-12-3
%{_prefix}/bin/gcc-ranlib-12-3
%{_prefix}/bin/lto-dump-12-3
%ifarch ppc
...
%endif
%{_prefix}/bin/%{gcc_target_platform}-gcc-12-3
%{_prefix}/bin/%{gcc_target_platform}-gcc-%{gcc_major}
%{_mandir}/man1/gcc-12-3.1*
%{_mandir}/man1/gcov-12-3.1*
%{_mandir}/man1/gcov-tool-12-3.1*
%{_mandir}/man1/gcov-dump-12-3.1*
%{_mandir}/man1/lto-dump-12-3.1*
%{_infodir}/gcc*
%dir %{_prefix}/lib/gcc
...
%{_libdir}/bfd-plugins/liblto_plugin-12-3.so
...
%files -n compat-cpp-12-3
%{_prefix}/lib/cpp-12-3
%{_prefix}/bin/cpp-12-3
%{_mandir}/man1/cpp-12-3.1*
%{_infodir}/cpp*
%dir %{_prefix}/libexec/gcc
%dir %{_prefix}/libexec/gcc/%{gcc_target_platform}
%dir %{_prefix}/libexec/gcc/%{gcc_target_platform}/%{gcc_major}
...
%files -n compat-libgcc-12-3
/%{_lib}/libgcc_s-%{gcc_major}-%{DATE}.so.1
/%{_lib}/libgcc_s.so.1
%{!?_licensedir:%global license %%doc}

%files c++
%{_prefix}/bin/%{gcc_target_platform}-*++-12-3
%{_prefix}/bin/g++-12-3
%{_mandir}/man1/g++-12-3.1*
%dir %{_prefix}/lib/gcc
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}/%{gcc_major}
%dir %{_prefix}/libexec/gcc
...
%files -n compat-libstdc++-12-3-devel
...
%files -n compat-libstdc++-12-3-static
%dir %{_prefix}/lib/gcc
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}/%{gcc_major}
%ifarch sparcv9 ppc
...
%if %{build_libstdcxx_docs}
%files -n compat-libstdc++-12-3-docs
%{_mandir}/man3/*
%endif
...
%files gfortran
%{_prefix}/bin/gfortran-12-3
%{_mandir}/man1/gfortran-12-3.1*
%{_infodir}/gfortran*
%dir %{_prefix}/lib/gcc
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}/%{gcc_major}
...
%files -n compat-libgfortran-12-3
%{_prefix}/%{_lib}/libgfortran.so.5*

%files -n compat-libgfortran-12-3-static
%dir %{_prefix}/lib/gcc
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}
%dir %{_prefix}/lib/gcc/%{gcc_target_platform}/%{gcc_major}
%ifarch sparcv9 ppc
...
%files -n compat-libgomp-12-3-offload-nvptx
...
%changelog
* Fri Apr  5 2024 Steven Boswell <ulatekh@yahoo.com> 12.3-1-1
- Compatibility compiler build
